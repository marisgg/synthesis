...
std::shared_ptr<modelchecker::ExplicitQuantitativeCheckResult<ConstantType>> SparseDerivativeInstantiationModelCheckerFamily<FunctionType, ConstantType>::check(
    ...
    auto ptr = std::make_unique<modelchecker::ExplicitQuantitativeCheckResult<ConstantType>>(finalResult);

    return ptr;
}

template<typename FunctionType, typename ConstantType>
void SparseDerivativeInstantiationModelCheckerFamily<FunctionType, ConstantType>::specifyFormula(
...
template<typename FunctionType, typename ConstantType>
void SparseDerivativeInstantiationModelCheckerFamily<FunctionType, ConstantType>::initializeInstantiatedMatrix(
...
template class SparseDerivativeInstantiationModelCheckerFamily<RationalFunction, RationalNumber>;
template class SparseDerivativeInstantiationModelCheckerFamily<RationalFunction, double>;
}  // namespace derivative
}  // namespace storm
