...
ConstantType GradientDescentInstantiationSearcherFamily<FunctionType, ConstantType>::doStep(
...
GradientDescentInstantiationSearcherFamily<FunctionType, ConstantType>::gradientDescent() {
...
template<typename FunctionType, typename ConstantType>
void GradientDescentInstantiationSearcherFamily<FunctionType, ConstantType>::resetDynamicValues() {
    if (Adam* adam = boost::get<Adam>(&gradientDescentType)) {
...
template<typename FunctionType, typename ConstantType>
void GradientDescentInstantiationSearcherFamily<FunctionType, ConstantType>::printRunAsJson() {
    STORM_PRINT("[");
...
template<typename FunctionType, typename ConstantType>
std::vector<typename GradientDescentInstantiationSearcherFamily<FunctionType, ConstantType>::VisualizationPoint>
GradientDescentInstantiationSearcherFamily<FunctionType, ConstantType>::getVisualizationWalk() {
    return walk;
}

template class GradientDescentInstantiationSearcherFamily<RationalFunction, RationalNumber>;
template class GradientDescentInstantiationSearcherFamily<RationalFunction, double>;
}  // namespace synthesis
}
